...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 px-4 py-3 border-b border-gray-100",
      className
    )}
    {...props}
  />
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 px-4 py-3 border-t border-gray-100",
      className
    )}
    {...props}
  />
